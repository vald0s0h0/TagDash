// Settings → Comptes & Système → Sync TradeTally. Ported from the former SyncStatusModal —
// same query/content, just dropped the Dialog wrapper.
    ...
    <div>
      ...
      {data && (
        <>
          ...
          <ScrollArea className="mt-1 h-72">
