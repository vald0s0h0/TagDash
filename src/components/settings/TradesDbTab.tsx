// Settings → Données stockées → Trades (DB). Ported from the former TradesDBModal — same
// query/table/search/sort/delete, just dropped the Dialog wrapper and resized to fill the
// fixed-size Settings content pane.
...
export function TradesDbTab() {
  ...
  return (
    <div className="flex h-full flex-col gap-0">
      ...
      {/* Confirmation banner */}
      {confirmDelete && (
        <div className="flex shrink-0 items-center gap-3 border-b border-red-900/40 bg-red-950/30 px-3 py-2 text-xs text-red-300">
          <span>
